	...
	<table>
		<thead>
			<tr>
				...
				<th class="sortable-column sort-asc text-center">Kode Barang</th>
				<th class="sortable-column sort-asc text-center">Jumlah</th>
				<th class="sortable-column sort-asc text-center">Harga Beli</th>
				<th class="sortable-column sort-asc text-center">Harga Jual</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				...
				<td>Rp. {{$key->hargabeli}}</td>
				<td>Rp. {{$key->hargajual}}</td>
			</tr>
			@endforeach
		</tbody>
	</table>
