...
<div class="py-2">
	<button type="button" class="button button-info float-right mb-1" onclick="Metro.dialog.open('#d-tambahunit') ">
	...
	<tbody>
		...
		<td>{{$loop->iteration}}</td>
			...
			<td class="text-center">
				<center>
					<a class="button info" href="{{route('unit.edit', $unit->id)}}">
					<span class="mif-pencil"></span> Edit</a>
				<a class="button alert" href="{{route('unit.delete', $unit->id)}}"><span class="mif-bin"></span> Delete</a>
				</center>
			</td>
		</tr>
		@endforeach
