...
function createWindowModal(){
    Desktop.createWindow({
        ...
        title: "Modal window",
        content: "<div class='p-2'><div class='input'><input type='text' data-role='input' data-prepend='Nama' placeholder='Nama Instansi' data-validate='minlength=6' class=' data-role-input='true' name='nama'></div><br><div class='input'><input type='number' data-role='input' data-prepend='Telepon' placeholder='Telepon' data-validate='minlength=6' class=' data-role-input='true' name='telepon'></div><br><div class='input'><input type='text' data-role='input' data-prepend='Kode Pos' placeholder='Kode Pos' data-validate='minlength=6' class=' data-role-input='true' name='kodepos'></div><br><div class='input'><input type='text' data-role='input' data-prepend='Deskripsi' placeholder='Deskripsi' data-validate='minlength=6' class=' data-role-input='true' name='desktipsi'></div><br><div class='input'><input type='text' data-role='input' data-prepend='Alamat' placeholder='Alamat' data-validate='minlength=6' class=' data-role-input='true' name='alamat'></div><br><div class='input'><input type='text' data-role='input' data-prepend='Logo' placeholder='Logo' data-validate='minlength=6' class=' data-role-input='true' name='logo'></div><br><button type='submit' class='button pull-right'>Tambah Data</button></div>",
        overlay: true,
